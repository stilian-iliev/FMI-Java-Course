...
public interface RevolutAPI {
	 ...
	 *
	 * @param card     the card used for the payment. Only physical cards are
	 *                 accepted
	 * @param pin      4-digit PIN
	 * @param amount   the amount paid
	 * @param currency the currency of the payment ("BGN" or "EUR")
	 * @return true, if the operation is successful and false otherwise. Payment is
	 *         successful, if the card is available in Revolut, valid, unblocked,
	 *         the specified PIN is correct and an account with sufficient amount in
	 *         the specified currency exists. In case of three consecutive incorrect
	 *         PIN payment attempts, the card should be blocked.
	 **/
	 ...
	 * @param amount   the amount paid
	 * @param currency the currency of the payment ("BGN" or "EUR")
	 * @param shopURL  the shop's domain name. ".biz" top level domains are
	 *                 currently banned and payments should be rejected
	 * @return true, if the operation is successful and false otherwise. Payment is
	 *         successful, if the card is available in Revolut, valid, unblocked,
	 *         the specified PIN is correct and an account with sufficient amount in
	 *         the specified currency exists. In case of three consecutive incorrect
	...
	/**
	 * Transfers money between accounts, doing currency conversion, if needed. The
	 * official fixed EUR to BGN exchange rate is 1.95583.
	 *
	 ...
	 * @return true if both accounts exist and are different (with different IBANs)
	 *         and false otherwise
	 **/
	 ...
	 *
	 * @return The total available amount (the sum of amounts for all accounts), in
	 *         BGN
	 **/
